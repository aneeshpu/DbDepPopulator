...
public class ColumnTest {
    ...
    public void considers_two_columns_from_the_same_table_with_same_names_are_equal() {
        ...
        final Column idColumn = Column.buildColumn().withName("id").withTable(new RecordBuilder(connection).setName("payment").withPreassignedValues(new HashMap<String, Map<String, Object>>()).setColumnCreationStrategy(new AutoIncrementBasedCreation()).createRecord()).create();
        final Column anotherIdColumn = Column.buildColumn().withName("id").withTable(new RecordBuilder(connection).setName("payment").withPreassignedValues(new HashMap<String, Map<String, Object>>()).setColumnCreationStrategy(new AutoIncrementBasedCreation()).createRecord()).create();
